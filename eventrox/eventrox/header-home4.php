            ...
            <div class="auto-container">
                ...
                <div class="clearfix">
                    ...
                    <div class="top-left pull-left">
                        ...
                        <div class="text"><?php if(isset($eventrox_redux_demo['header_text'])){?>

                                    <?php echo htmlspecialchars_decode(esc_attr($eventrox_redux_demo['header_text']));?>

                                    <?php }else{?>

                                    <?php echo esc_html__( 'Best choice for Eventrox & Party Events.', 'eventrox' );
                    ...
                    <div class="pull-right">
                        ...
                        <a href="<?php if(isset($eventrox_redux_demo['register_button'])){?>

                                    <?php echo htmlspecialchars_decode(esc_attr($eventrox_redux_demo['register_link']));?>
                                    ...
                                    ?>" class="theme-btn register-btn"><?php if(isset($eventrox_redux_demo['register_button'])){?>

                                    <?php echo htmlspecialchars_decode(esc_attr($eventrox_redux_demo['register_button']));?>

                                    <?php }else{?>

                                    <?php echo esc_html__( 'Register Now', 'eventrox' );
