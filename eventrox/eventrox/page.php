...
<!-- basic-breadcrumb start -->
        ...
        <div class="banner-area grid-two" style="background: url(<?php echo esc_url($eventrox_redux_demo['page_image']['url']); ?>) no-repeat scroll center top / cover;">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title text-center">
                            ...
                            <p class="text-white"><?php echo esc_attr($eventrox_redux_demo['page_subtitle'])?></p>
                        </div>
                    </div>
                </div>
                <div class="row">
