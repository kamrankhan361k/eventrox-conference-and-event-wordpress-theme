	...
	public function import_files_config() {
		...
		$home_prevs = array(
			'medinet_home_1' => array(
				'title' => __( 'Import Eventrox', 'eventrox' ),
				'page'  => __( 'Home', 'eventrox' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/screenshot.png',
				'preview_link' => 'https://shtheme.com/demosd/eventrox/',
			),
			'medinet_home_2' => array(
				'title' => __( 'Import Eventrox Home Classic', 'eventrox' ),
				'page'  => __( 'Home Classic', 'eventrox' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/screenshot.png',
				'preview_link' => 'https://shtheme.com/demosd/eventrox/?page_id=66',
			),
			'medinet_home_3' => array(
				'title' => __( 'Import Eventrox Home Conference', 'eventrox' ),
				'page'  => __( 'Home Conference', 'eventrox' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/screenshot.png',
				'preview_link' => 'https://shtheme.com/demosd/eventrox/?page_id=133',
			),
			'medinet_home_4' => array(
				'title' => __( 'Import Eventrox Home Meetup', 'eventrox' ),
				'page'  => __( 'Home Meetup', 'eventrox' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/screenshot.png',
				'preview_link' => 'https://shtheme.com/demosd/eventrox/?page_id=201',
			),
			'medinet_home_5' => array(
				'title' => __( 'Import Eventrox Home Page Digital', 'eventrox' ),
				'page'  => __( 'Home Page Digital', 'eventrox' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/screenshot.png',
				'preview_link' => 'https://shtheme.com/demosd/eventrox/?page_id=253',
			),
			'medinet_home_6' => array(
				'title' => __( 'Import Eventrox Home Page Four', 'eventrox' ),
				'page'  => __( 'Home Page Four', 'eventrox' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/screenshot.png',
				'preview_link' => 'https://shtheme.com/demosd/eventrox/?page_id=245',
			),
		);
		...
		foreach ( $home_prevs as $key => $prev ) {
			...
			$config[] = array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'eventrox' ),
			);
		}
