...
<?php } ?>
        <div class="auto-container">
            <h1><?php
                        if ( is_day() ) :
                            printf( esc_html__( 'Daily Archives: %s', 'eventrox' ), get_the_date() );
                        elseif ( is_month() ) :
                            printf( esc_html__( 'Monthly Archives: %s', 'eventrox' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'eventrox' ) ) );
                        elseif ( is_year() ) :
                            printf( esc_html__( 'Yearly Archives: %s', 'eventrox' ), get_the_date( _x( 'Y', 'yearly archives date format', 'eventrox' ) ) );
                        else :
                            echo esc_html__( 'Archives', 'eventrox' );
                        endif;?></h1>
